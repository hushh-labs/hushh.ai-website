...
import TryItOut from '../../src/app/_components/developerApiContent/tryItOut'
...
<TryItOut
  ...
  subtitle="Pick a workflow on the left, edit the payload, and send a request to the test endpoint."
