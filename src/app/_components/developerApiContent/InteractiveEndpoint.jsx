...
const InteractiveEndpoint = ({ method, path, description, curlCommand, responseExample }) => {
  ...
  }[method] || 'bg-gray-500/10 text-gray-700 dark:text-gray-400 border-gray-500/20';
      ...
      <div className="p-4 bg-[var(--bg-secondary)]">
        ...
        <div className="flex border-b border-[var(--border-primary)] mb-0">
          <button
            ...
            className={`px-4 py-2 text-xs font-medium border-b-2 transition-colors ${activeTab === 'request'
          ...
          <button
            ...
            className={`px-4 py-2 text-xs font-medium border-b-2 transition-colors ${activeTab === 'response'
                ? 'border-[var(--accent-primary)] text-[var(--text-primary)]'
                : 'border-transparent text-[var(--text-tertiary)] hover:text-[var(--text-secondary)]'
              }`}
          >
